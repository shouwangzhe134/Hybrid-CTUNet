...
from networks.hybrid_CTUNet import CUNet
from networks.hybrid_CTUNet import TUNet
from optimizers.lr_scheduler import LinearWarmupCosineAnnealingLR
from trainer_TUNet import run_training as run_training_TUNet
from trainer_CUNet import run_training as run_training_CUNet
from utils.data_utils import get_loader


from monai.losses import DiceCELoss

# import debugpy; debugpy.connect(('172.20.35.175', 5678))
...
parser.add_argument("--model_depths", default=101, type=int, help="resnet model depth")
parser.add_argument("--model_name", default="c_t_unet", type=str, help="model name")
parser.add_argument("--patch_frame", default=8, type=int, help="patch frame")
...
def main_worker(gpu, args):
    ...
    invert_transform, loader = get_loader(args)
    ...
    if args.model_name == "tunet":
        accuracy = run_training_TUNet(
            model=model,
    ...
    elif args.model_name == "cunet": 
        accuracy = run_training_CUNet(
            model=model,
            train_loader=loader[0],
            val_loader=loader[1],
            optimizer=optimizer,
